...
public class ShopingItemAdapter
        extends RecyclerView.Adapter<ShopingItemAdapter.ViewHolder>
        implements Filterable {
    // Member variables.
    private ArrayList<ShopingItem> mShoppingData;
    private ArrayList<ShopingItem> mSoppingDataAll;
    ...
    public void onBindViewHolder(ShopingItemAdapter.ViewHolder holder, int position) {
        // Get current sport.
        ShopingItem currentItem = mShoppingData.get(position);
    ...
    private Filter shoppingFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            if(charSequence == null || charSequence.length() == 0) {
                ...
                for(ShopingItem item : mSoppingDataAll) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bindTo(ShopingItem currentItem){
            ...
            Animation animbouncy = AnimationUtils.loadAnimation(mContext, R.anim.bouncy);
            itemView.findViewById(R.id.add_to_cart).startAnimation(animbouncy);
        }
    }
}